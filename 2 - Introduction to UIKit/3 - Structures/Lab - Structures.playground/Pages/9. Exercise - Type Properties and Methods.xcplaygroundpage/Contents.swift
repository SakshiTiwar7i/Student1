 ...
 */
struct User {
    static var currentUser: User = User(userName: "sakshi", email: "st04@icloud.com", age: 23)
...
let newUser = User(userName: "SakshiTiwari", email: "sakshithegreat@icloud.com", age: 2)
