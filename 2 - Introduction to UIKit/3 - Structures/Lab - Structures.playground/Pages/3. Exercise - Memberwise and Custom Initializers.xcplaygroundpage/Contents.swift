...
print("favorite book is \(favoriteBook.title) by \(favoriteBook.author). It is \(favoriteBook.pages) pages long and costs \(favoriteBook.price) dollars to get the paperback copy.")
/*:
...
var refurbishedLaptop = Laptop(screenSize: 13, repairCount: 1, yearPurchased: 2024)
/*:
